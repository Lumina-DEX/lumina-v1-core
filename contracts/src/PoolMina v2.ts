import { Field, SmartContract, Permissions, state, State, method, TokenContractV2, PublicKey, AccountUpdateForest, DeployArgs, UInt64, AccountUpdate, Provable, VerificationKey, Int64 } from 'o1js';
...
export class PoolMina extends TokenContractV2 {
    ...
    @method async supplyFirstLiquidities(amountToken: UInt64, amountMina: UInt64) {
        ...
        await tokenContract.approveAccountUpdates([from, to]);
