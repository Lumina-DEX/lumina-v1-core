 ...
 */
export class PoolFactoryOld extends TokenContract implements PoolFactoryBase {
  /**
   ...
   */
  @method
  async updateVerificationKey(multisig: MultisigOld, vk: VerificationKey) {
   ...
   */
  @method
  async setNewProtocol(multisig: MultisigOld, newUser: PublicKey) {
   ...
   */
  @method
  async setNewDelegator(multisig: MultisigOld, newUser: PublicKey) {
