...
import { FungibleTokenAdminProof, FungibleTokenAdminBase } from "./FungibleTokenAdminProof.js"
...
export class FungibleTokenProof extends TokenContractV2 {
  @state(UInt8)
  ...
  static AdminContract: new (...args: any) => FungibleTokenAdminBase = FungibleTokenAdminProof
  ...
  public async getAdminContract(): Promise<FungibleTokenAdminBase> {
    ...
    return (new FungibleTokenProof.AdminContract(admin))
  }
