...
import { checkToken, IPool } from '../pool/IPoolState.js';
 ...
 */
export class PoolIntermediary extends TokenContract implements IPool {
    ...
    @method async updateVerificationKey() {
        ...
        const factory = new PoolFactoryUpgradeTest(factoryAddress);
