 ...
 */
export class FungibleTokenAdminProof extends SmartContract implements FungibleTokenAdminBase {
  @state(PublicKey)
  ...
  private async ensureAdminSignature() {
    ...
    const accountUpdate = AccountUpdate.create(admin);
    accountUpdate.body.mayUseToken = AccountUpdate.MayUseToken.ParentsOwnToken;
