...
import { TokenAdminMint, FungibleTokenAdminBase } from "./TokenAdminMint.js"
...
export class FungibleTokenMint extends TokenContractV2 {
    @state(UInt8)
    ...
    static AdminContract: new (...args: any) => FungibleTokenAdminBase = TokenAdminMint
    ...
    public async getAdminContract(): Promise<FungibleTokenAdminBase> {
        ...
        return (new FungibleTokenMint.AdminContract(admin))
    }
